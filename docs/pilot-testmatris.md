...
| --- | --- | --- | --- | --- | --- |
| S1 | Miljövariabler satta | Kontrollera `.env.local` | URL/keys för Supabase + OpenAI finns | ☐ Pass ☐ Fail | |
| S2 | Databas schema applicerat | Kör/validera `supabase/schema.sql` i Supabase | Tabeller, index, RLS och policies finns utan fel | ☐ Pass ☐ Fail | |
| S3 | App startar | Starta med `npm run dev:3001` | App laddar på `http://localhost:3001` | ☐ Pass ☐ Fail | |

## 2. Auth och åtkomst (RLS)

| ID | Testfall | Steg | Förväntat resultat | Status | Kommentar |
| --- | --- | --- | --- | --- | --- |
| A1 | Inloggad användare ser egen data | Logga in med User A | Endast org-kopplad data visas | ☐ Pass ☐ Fail | |
| A2 | Användare utanför org blockeras | Logga in med User B utan medlemskap | Ingen åtkomst till User A:s data | ☐ Pass ☐ Fail | |
| A3 | Användare i samma org får åtkomst | Lägg User B i samma org och logga in | Delad org-data visas korrekt | ☐ Pass ☐ Fail | |
...
| ID | Testfall | Steg | Förväntat resultat | Status | Kommentar |
| --- | --- | --- | --- | --- | --- |
| ST1 | Status: draft -> in_review | Byt status i Ansökan | Tillåten övergång sparas och visas | ☐ Pass ☐ Fail | |
...
| ID | Testfall | Steg | Förväntat resultat | Status | Kommentar |
| --- | --- | --- | --- | --- | --- |
| E1 | Skapa evidenspost | Lägg till evidens i Ansökan | Post skapas och syns i lista | ☐ Pass ☐ Fail | |
...
| ID | Testfall | Steg | Förväntat resultat | Status | Kommentar |
| --- | --- | --- | --- | --- | --- |
| D1 | Export DOCX | Exportera dokument | Fil laddas ner och går att öppna | ☐ Pass ☐ Fail | |
| D2 | Export PDF | Exportera dokument | Fil laddas ner och går att öppna | ☐ Pass ☐ Fail | |
...
| R3 | Tomma/ogiltiga indata | Skapa evidens utan obligatoriska fält | Valideringsfel visas korrekt | ☐ Pass ☐ Fail | |
