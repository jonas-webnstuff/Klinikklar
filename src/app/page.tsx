...
const pricingPlans = [
  {
    ...
    price: "9 995 kr",
    billing: "engång",
    description: "För kliniker som behöver hjälp med själva ansökan, inklusive AI-stöd i ansökningsarbetet, utan löpande abonnemang.",
  ...
  },
  {
    ...
    price: "1 995 kr",
    billing: "/mån",
    description: "För kliniker som vill ha premiumfunktioner, AI-stöd i ansökan, hög AI-nivå och avancerad revisionsberedskap.",
    footerNote: "Startavgift 19 900 kr",
    features: [
